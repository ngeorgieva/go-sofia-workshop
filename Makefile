...
PROJECT?=github.com/ngeorgieva/go-sofia-workshop
BUILD_PATH?=cmd/go-sofia-workshop
APP?=go-sofia-workshop
...
deploy: push
	helm upgrade --force ${CONTAINER_NAME} -f charts/${VALUES}.yaml charts \
